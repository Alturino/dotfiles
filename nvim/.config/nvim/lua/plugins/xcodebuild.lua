return {
  ...
  keys = {
    ...
    { "<leader>xcpm", "<cmd>XcodebuildProjectManager<cr>",         desc = "Show Project Manager Actions" },
    ...
    { "<leader>xct",  "<cmd>XcodebuildTestSelected<cr>",           desc = "Run Selected Tests" },
    { "<leader>xctc", "<cmd>XcodebuildTestClass<cr>",              desc = "Run Current Test Class" },
    { "<leader>xct",  "<cmd>XcodebuildTestRepeat<cr>",             desc = "Repeat Last Test Run" },
    ...
    { "<leader>xccr", "<cmd>XcodebuildShowCodeCoverageReport<cr>", desc = "Show Code Coverage Report" },
    { "<leader>xcpg", "<cmd>XcodebuildPreviewGenerateAndShow<cr>", desc = "Generate Preview" },
    { "<leader>xcp",  "<cmd>XcodebuildPreviewToggle<cr>",          desc = "Toggle Preview" },
    { "<leader>xcs",  "<cmd>XcodebuildSelectDevice<cr>",           desc = "Select Device" },
